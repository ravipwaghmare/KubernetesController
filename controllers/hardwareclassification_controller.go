...
import (
	...
	metal3v1alpha1 "test/testcontroller/api/v1alpha1"
)
...
// +kubebuilder:rbac:groups=metal3.metal3.io,resources=hardwareclassifications,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=metal3.metal3.io,resources=hardwareclassifications/status,verbs=get;update;patch
...
func (r *HardwareClassificationReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&metal3v1alpha1.HardwareClassification{}).
		Complete(r)
}
